...
lblInfo=Label(Tops,font=('helvetica',50,'bold'),text="KaaKe Jaa",fg="Black",bd=10,anchor='w')
...
def Ref():
    ...
    cd=("Cost of Blue Mojito= "+str(CostofDrinks))
    cf=("Cost of Manchuria= "+str(CostofFries))
    cn=("Cost of Noodles= "+str(CostofNoodles))
    cs=("Cost of Soup= "+str(CostofSoup))
    cb=("Cost of Biriyani= "+str(CostBurger))
    css=("Cost of Paneer Butter Masala= "+str(CostSandwich))
    cm1=("Subtotal= "+str(CostofDrinks+CostofFries+CostofNoodles+CostofSoup+CostBurger+CostSandwitch))
    st1=("Satya Tax= "+str(st))
    pt1=("GST= "+str(pt))
    t1=("Total= "+str(t))
...
lblFries= Label(f1, font=('arial', 16, 'bold'),text="Manchuria",bd=16,anchor="w")
...
lblBurger= Label(f1, font=('arial', 16, 'bold'),text="Biriyani",bd=16,anchor="w")
...
lblSandwich= Label(f1, font=('arial', 16, 'bold'),text="Paneer Butter Masala",bd=16,anchor="w")
